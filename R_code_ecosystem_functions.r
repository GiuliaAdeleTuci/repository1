...
levelplot(copNDVI10)
# to make the map smoother  

#10k pixels together, very coarse low detail 
...
#defor1_.1 etc are the names of the band i can obtain them by sending on R only the name of the object (ex. defor1)
...
#let's see the difference in the dvi between the first one and the secondo one 
difdvi <- dvi1 - dvi2
dev.off()
