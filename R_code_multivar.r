...
# we downloaded the dataset, now we associate the name biomes with the functions, sep means that the columns in the original file are separated with a comm
...
# then kind is the argument and ehull is the type of graph we are using, and the dimension of the line 
